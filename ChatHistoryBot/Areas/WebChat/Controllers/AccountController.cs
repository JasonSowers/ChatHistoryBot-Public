using ChatHistoryBot.App_Start;
...
namespace ChatHistoryBot.Areas.WebChat.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private Models.LoginViewModel _loginViewModel;
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    //TODO: Security
                    //SaveUserKey();
                    return RedirectToAction("Index", "Bot", new { area = "WebChat" });
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            ViewBag.ReturnUrl = RedirectToAction("Index", "Bot", new { area = "WebChat" });
            return View(model);
        }
...
//                UserId = CryptoHelpers.EncryptString(UserId, "1234", false),
